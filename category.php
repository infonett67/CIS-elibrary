...
<body data-bs-spy="scroll" data-bs-target=".navbar">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <h1 class="p-4"> Welcome <?php echo $_SESSION['username']?></h1>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 section-intro text-center">
                    <h1 style="color:#bd9e55">Categories</h1>
            ...
            <div class="row g-4 text-start" >
                ...
                <div class="col-md-4" data-aos="fade-up">
                    <div class="review p-4">
                        <div class="person">
                            <!-- <i class="fas fa-book" style="color:#1107fe"></i> -->
                            <img src="images/book1.png" alt="" width="100px" height="100px">
                            <div class="text ms-3">
                                <a href="searchpage.php?id=<?php echo $category["id"]?>">
                                    <h6 class="mb-0" style="color:#bd9e55"><?php echo $category["cat_name"]?></h6>
                                    <small></small>
                                </a>
                            </div>
                        </div>                
